...
urlpatterns = [
    ...
    path("number/<int:pk>/", views.NumberView.as_view(), name="number_view"),  # Backward compatibility
    ...
    # Voice Circuit URLs
    path("voice_circuit/<int:pk>/", views.VoiceCircuitView.as_view(), name="voicecircuit"),
    path("voice_circuit/<int:pk>/", views.VoiceCircuitView.as_view(), name="voice_circuit_view"),  # Backward compatibility
